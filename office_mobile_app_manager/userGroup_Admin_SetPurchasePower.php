    ...
    <ul class="navbar-nav">
	  <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="#">Set Purchase Power</a>
	  ...
	  <li class="nav-item">
        <a class="nav-link" href="#"><b>Set Purchase Power</b></a>
      </li>
...
<a class="btn btn-light" href="userGroup_Admin_AddPurchasePower.php" role="button">Add Purchase Power</a>
<hr>
<a class="btn btn-light" href="userGroup_Admin_AddPurchasePower_old.php" role="button">Add Purchase Power(Old)</a>
<hr>
<a class="btn btn-light" href="userGroup_Admin_RemovePurchasePower.php" role="button">Remove Purchase Power</a>
<hr>
<a class="btn btn-light" href="userGroup_Admin_RemovePurchasePower_old.php" role="button">Remove Purchase Power(Old)</a>
